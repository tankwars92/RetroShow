var UT_RATING_IMG = 'img_/star_smn.gif';
var UT_RATING_IMG_HOVER = 'img_/star_hover.gif';
var UT_RATING_IMG_HALF = 'img_/star_smn_half.gif';
var UT_RATING_IMG_BG = 'img_/star_smn_bg.gif';
var UT_RATING_IMG_REMOVED = 'img_/star_smn_bg.gif';
...
function UTRating(ratingElementId, maxStars, objectName, formName)
{
	...
	function greyStars() {
		for (var i=1; i < this.maxStars + 1; i++)
			if (i <= this.starCount)
				document.getElementById('star_' + i).src = UT_RATING_IMG_REMOVED;
			else
